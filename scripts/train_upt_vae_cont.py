...
from vitssm.data import get_dataloaders_continuous_ae
from vitssm.models import build_model
from vitssm.engine.tasks import ContinuousVideoAutoEncoderUPTEngine
...
def main(config: str):   
    ...
    with wandb.init(
        ...
        engine = ContinuousVideoAutoEncoderUPTEngine(model=model, run_object=run_config)
